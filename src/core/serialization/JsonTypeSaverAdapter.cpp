...
namespace Ortha::Core {
	...
	class AnySaverMapper {
		...
		static bool _trySaveAnyAsIntegral(Log& log,
			rapidjson::Value& outputValue, const Ortha::RTTI::Any& anyValue, rapidjson::Document::AllocatorType& allocator) {
		...
		static bool
		_trySaveAny(Log& log, rapidjson::Value& outputValue, const Ortha::RTTI::Any& anyValue, rapidjson::Document::AllocatorType& allocator) {
	...
	public:
		static bool
		trySaveAny(Log& log, rapidjson::Value& outputValue, const Ortha::RTTI::Any& anyValue, rapidjson::Document::AllocatorType& allocator) {
	...
	void save(Log& log, rapidjson::Value& outputValue, const Ortha::RTTI::Any& anyValue, rapidjson::Document::AllocatorType& allocator);

	template<typename T>
	void _save(Log&, rapidjson::Value&, const Ortha::RTTI::Any&, const T&, rapidjson::Document::AllocatorType&) {
		static_assert(false, "Unhandled type traits.");
	}

	// void _save(Log&,
	// 	rapidjson::Value&, const Ortha::RTTI::Any&, const VoidTypeTraits&,
	...
	std::string save(entt::registry& registry, const Ortha::RTTI::Any& anyValue) {
		Log log;
		return save(log, anyValue);
	}

	std::string save(Log& log, const Ortha::RTTI::Any& anyValue) {
