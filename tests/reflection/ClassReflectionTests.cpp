...
TEST_CASE("ClassProperty_ApplyPropertyToInstance_AddressAndValueMatches", "ClassReflection") {
    ...
    const ClassProperty firstProperty(TypeId::get<int32_t>(), "publicProperty", firstPropertyOffset, sizeof(TestClass::publicProperty));
    const ClassProperty secondProperty(TypeId::get<int32_t>(), "secondPublicProperty", secondPropertyOffset, sizeof(TestClass::secondPublicProperty));
...
TEST_CASE("ClassWithNestedClassProperties_ApplyPropertyToInstance_AddressAndValueMatches", "ClassReflection") {
    ...
    const ClassProperty nestedClassProperty(TypeId::get<TestClass2>(), "nestedClassProperty", nestedClassOffset, sizeof(TestClass2::nestedClassProperty));
    const ClassProperty firstProperty(TypeId::get<int32_t>(), "publicProperty", firstPropertyOffset, sizeof(TestClass::publicProperty));
    const ClassProperty secondProperty(TypeId::get<int32_t>(), "secondPublicProperty", secondPropertyOffset, sizeof(TestClass::secondPublicProperty));
